...
public class ViewUniqueConstraint {
	@InjectRequirement
	...
	private static final String PROJECT_NAME = "ViewUniqueConstraint";
	private static final String NAME_VIEW_MODEL = "ViewModelUniqueConstraint";
	private static final String NAME_VDB = "ViewModelUniqueConstraintVDB";
	private static final String NAME_ORIGINAL_DYNAMIC_VDB = NAME_VDB + "-vdb.xml";
	
	private static final String NAME_GENERATED_DYNAMIC_VDB = "ViewUniqueConstraintVDBgenerated-vdb.xml";
