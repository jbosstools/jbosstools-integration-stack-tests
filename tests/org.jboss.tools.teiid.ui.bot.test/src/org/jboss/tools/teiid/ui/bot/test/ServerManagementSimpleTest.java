 ...
 * 
 * @author lfabriko (linux fedora 18, 64bit locally - 8 min)
 */
...
public class ServerManagementSimpleTest extends SWTBotTestCase {
	...
	public static void createModelProject() {
		...
		if (System.getProperty("swtbot.PLAYBACK_DELAY") == null) {
			...
			SWTBotPreferences.PLAYBACK_DELAY = new Integer(System.getProperty("swtbot.PLAYBACK_DELAY"));// -Dswtbot.PLAYBACK_DELAY
		}
	...
	private boolean canExecuteVDB(String message, String vdbName, String sql) {
		...
		if (message != null) {
			new GuidesView().chooseAction("Model JDBC Source", "Execute VDB");// just select action to execute VDB and
