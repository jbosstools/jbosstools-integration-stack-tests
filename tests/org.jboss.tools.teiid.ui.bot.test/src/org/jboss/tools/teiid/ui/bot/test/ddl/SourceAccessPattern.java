...
public class SourceAccessPattern {
	@InjectRequirement
	...
	private static final String PROJECT_NAME = "SourceAccessPattern";
	private static final String NAME_SOURCE_MODEL = "AccessPatternSourceModel";
	private static final String NAME_VDB = "AccessPatternVDB";
	private static final String NAME_ORIGINAL_DYNAMIC_VDB = NAME_VDB + "-vdb.xml";
	
	private static final String NAME_GENERATED_DYNAMIC_VDB = "AccessPatternVDBgenerated-vdb.xml";
