...
public class DslrEditorTest extends TestParent {
    ...
    public void testConstraintsCompletion() {
        ...
        Assert.assertEquals("Wrong text inserted", "- with an? {attr} greater than {amount}", editor
                .getTextOnCurrentLine().trim());
    ...
    public void testConsequenceCompletion() {
        ...
        Assert.assertEquals("Wrong translation", "System.out.println(\"Hello world!\");", drl.getTextOnCurrentLine()
                .trim());
    }
