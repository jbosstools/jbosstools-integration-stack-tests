...
public class DslrEditorTest extends TestParent {
	...
	public void createDsl() {
		...
		{ // create *.dslr file
			...
			wizard.getFirstPage().setFileName(getMethodName());
			...
			editor.setText(String.format(getTemplateText("dslr/DslrTestFile"), getMethodName()));
			editor.close(true);
		}
	}
	...
	private DslrEditor openTestDslr() {
		OpenUtility.openResource(DEFAULT_PROJECT_NAME, getResourcePath(getMethodName() + ".dslr"));
