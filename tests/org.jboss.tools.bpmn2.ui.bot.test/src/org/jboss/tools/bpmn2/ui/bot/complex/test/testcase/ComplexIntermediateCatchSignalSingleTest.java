...
@JBPM6ComplexTestDefinition(projectName = "JBPM6ComplexTest", importFolder = "resources/bpmn2/model/base", openFile = "BaseBPMN2-IntermediateCatchSignalSingle.bpmn2", saveAs = "BPMN2-IntermediateCatchSignalSingle.bpmn2", knownIssues = {
	"1184422" })
public class ComplexIntermediateCatchSignalSingleTest extends JBPM6ComplexTest {
	...
	public void model() {
		...
		SignalIntermediateCatchEvent catchEvent = (SignalIntermediateCatchEvent) userTask.append("Catch",
				ElementType.SIGNAL_INTERMEDIATE_CATCH_EVENT);
	...
	public void run(KieSession kSession) {
		...
		assertEquals("Process variable " + VARIABLE1 + " didn't changed.", "batman is comming",
