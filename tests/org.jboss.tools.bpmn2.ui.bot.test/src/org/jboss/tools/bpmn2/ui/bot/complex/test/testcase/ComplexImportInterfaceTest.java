...
@JBPM6ComplexTestDefinition(projectName="JBPM6ComplexTest",
							...
							openFile="BaseBPMN2-ImportInterface.bpmn2",
							saveAs="BPMN2-ImportInterface.bpmn2")
/**
...
public class ComplexImportInterfaceTest extends JBPM6ComplexTest {
	...
	public void run(KieSession kSession) {
		WorkflowProcessInstance processInstance = (WorkflowProcessInstance) kSession.startProcess("BPMN2ImportInterface");
