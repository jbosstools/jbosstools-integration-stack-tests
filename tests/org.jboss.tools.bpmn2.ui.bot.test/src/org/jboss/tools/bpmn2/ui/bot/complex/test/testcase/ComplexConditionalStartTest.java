...
public class ComplexConditionalStartTest extends JBPM6ComplexTest {
	...
	public void model() {
		...
		ConditionalStartEvent startEvent = (ConditionalStartEvent) process.add(N_START,
				ElementType.CONDITIONAL_START_EVENT);
	...
	public void run(KieSession kSession) {
		TriggeredNodesListener triggeredNodes = new TriggeredNodesListener(Arrays.asList(N_START, N_HELLO, N_END),
				null);
