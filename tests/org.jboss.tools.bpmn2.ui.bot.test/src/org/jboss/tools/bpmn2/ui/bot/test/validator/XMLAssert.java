...
public class XMLAssert {
	 ...
	 */
	public void assertElementAttributes(String elementName, int elementIndex, String[] atttibuteNames,
		...
		Assert.assertEquals("Attributes do not match", expectedAttributes,
				getElementAttributes(elementName, elementIndex));
	}
