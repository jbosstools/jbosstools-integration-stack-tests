...
public class ComplexUserTaskTest extends JBPM6ComplexTest {
	...
	public void model() {
		...
		// task.addParameterMapping(new ParameterMapping(new FromExpression("mvel", "This is an urgent email #{x}"), new
		// ToDataInput("Body", "String"), ParameterMapping.Type.INPUT));
		// task.addParameterMapping(new ParameterMapping(new FromExpression("mvel", "Urgent email !"), new
		// ToDataInput("Subject", "String"), ParameterMapping.Type.INPUT));
		// task.addParameterMapping(new ParameterMapping(new FromExpression("mvel", "you@mail.com"), new
		// ToDataInput("To", "String"), ParameterMapping.Type.INPUT));
		// task.addParameterMapping(new ParameterMapping(new FromExpression("mvel", "ne@mail.com"), new
		// ToDataInput("From", "String"), ParameterMapping.Type.INPUT));
