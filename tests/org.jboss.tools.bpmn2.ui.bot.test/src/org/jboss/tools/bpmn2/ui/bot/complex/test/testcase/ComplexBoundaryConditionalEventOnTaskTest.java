...
@JBPM6ComplexTestDefinition(projectName = "JBPM6ComplexTest", importFolder = "resources/bpmn2/model/base", openFile = "BaseBPMN2-BoundaryConditionalEventOnTask.bpmn2", saveAs = "BPMN2-BoundaryConditionalEventOnTask.bpmn2", knownIssues = {
	"1263526" })
public class ComplexBoundaryConditionalEventOnTaskTest extends JBPM6ComplexTest {
	...
	public void model() {
		...
		ConditionalBoundaryEvent boundaryEvent = (ConditionalBoundaryEvent) userTask1
				.addEvent("Conditional Boundary Event", ElementType.CONDITIONAL_BOUNDARY_EVENT);
	...
	public void run(KieSession kSession) {
		...
		TriggeredNodesListener triggeredNodes = new TriggeredNodesListener(
				Arrays.asList("StartProcess", "User Task", "User Task 2", "End 1", "End 2", "Condition met"), null);
