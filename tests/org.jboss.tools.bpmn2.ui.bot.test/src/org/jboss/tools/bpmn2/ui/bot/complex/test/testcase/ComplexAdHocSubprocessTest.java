...
@JBPM6ComplexTestDefinition(projectName = "JBPM6ComplexTest", importFolder = "resources/bpmn2/model/base", openFile = "BaseBPMN2-AdHocSubProcess.bpmn2", saveAs = "BPMN2-AdHocSubProcess.bpmn2", knownIssues = "1263267")
public class ComplexAdHocSubprocessTest extends JBPM6ComplexTest {
	...
	public void buildProcessModel() {
		...
		AdHocSubProcess subprocess = (AdHocSubProcess) start.append("Hello", ElementType.AD_HOC_SUB_PROCESS,
				Position.SOUTH);
		...
		ScriptTask task2 = (ScriptTask) subprocess.addRelativeToElement("Hello2", ElementType.SCRIPT_TASK, task1,
				new Point(0, 80));
	...
	public void run(KieSession kSession) {
		...
		TriggeredNodesListener triggeredNodes = new TriggeredNodesListener(
				Arrays.asList("StartProcess", "Hello", "Goodbye", "EndProcess", "Hello1", "Hello2", "UserTask"), null);
