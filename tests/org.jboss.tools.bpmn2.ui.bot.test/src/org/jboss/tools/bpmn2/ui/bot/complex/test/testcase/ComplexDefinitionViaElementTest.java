...
@JBPM6ComplexTestDefinition(projectName = "JBPM6ComplexTest", importFolder = "resources/bpmn2/model/base", openFile = "BaseBPMN2-DefinitionViaElement.bpmn2", saveAs = "BPMN2-DefinitionViaElement.bpmn2", knownIssues = {
	"1211647",
	"1265167" })
