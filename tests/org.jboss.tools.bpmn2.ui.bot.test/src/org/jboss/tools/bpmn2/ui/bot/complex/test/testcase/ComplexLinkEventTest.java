...
@JBPM6ComplexTestDefinition(projectName = "JBPM6ComplexTest", importFolder = "resources/bpmn2/model/base", openFile = "BaseBPMN2-LinkEvent.bpmn2", saveAs = "BPMN2-LinkEvent.bpmn2", knownIssues = {
	"1190688" })
public class ComplexLinkEventTest extends JBPM6ComplexTest {
	...
	public void model() {
		...
		LinkIntermediateThrowEvent throwEventTwo = (LinkIntermediateThrowEvent) middleStep.append("MiddleStep",
	...
	public void runFirstVariant(KieSession kSession) {
		...
		WorkflowProcessInstance processInstance = (WorkflowProcessInstance) kSession.startProcess("BPMN2LinkEvent",
				args);
