...
@JBPM6ComplexTestDefinition(projectName = "JBPM6ComplexTest", importFolder = "resources/bpmn2/model/base", openFile = "BaseBPMN2-ExclusiveSplitPriority.bpmn2", saveAs = "BPMN2-ExclusiveSplitPriority.bpmn2")
public class ComplexExclusiveSplitPriorityTest extends JBPM6ComplexTest {
	...
	public void model() {
		...
		ExclusiveGateway gw2 = (ExclusiveGateway) task1.append("Join", ElementType.EXCLUSIVE_GATEWAY,
				Position.SOUTH_EAST);
