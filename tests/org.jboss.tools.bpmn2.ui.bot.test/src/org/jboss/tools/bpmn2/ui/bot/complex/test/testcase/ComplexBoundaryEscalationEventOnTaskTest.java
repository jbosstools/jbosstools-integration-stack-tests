...
public class ComplexBoundaryEscalationEventOnTaskTest extends JBPM6ComplexTest {
	...
	public void model() {
		...
		EscalationIntermediateThrowEvent throwEvent = (EscalationIntermediateThrowEvent) subStart
				.append("ThrowEscalation", ElementType.ESCALATION_INTERMEDIATE_THROW_EVENT);
		throwEvent.setEscalation(escalation, VARIABLE2);
		throwEvent.connectTo(new EndEvent("SubEnd"));

		EscalationBoundaryEvent boundaryEventSub = (EscalationBoundaryEvent) subProcess.add("EscalationBoundary",
