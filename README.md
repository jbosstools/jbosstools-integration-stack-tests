...
the [JBoss Tools JIRA](https://issues.jboss.org/browse/JBTIS)
describing the bug or new feature and give it a component type of
`QE`. Then we highly recommend making the changes on a
topic branch named with the JIRA issue number. For example, this
command creates a branch for the JBTIS-1234 issue:
