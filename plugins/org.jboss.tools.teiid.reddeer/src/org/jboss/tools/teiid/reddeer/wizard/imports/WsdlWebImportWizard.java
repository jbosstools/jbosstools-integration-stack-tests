...
public class WsdlWebImportWizard extends ImportWizardDialog {
	...
	public void fillFifthPage(Properties importProps) {
		if (importProps.getProperty("modelNameResponses") != null) {
			new SWTWorkbenchBot().textWithLabel("XML Model:").setText(importProps.getProperty("modelNameResponses")); // responses
																														// model
																														// name-
																														// model
																														// name
		...
		// new org.jboss.reddeer.swt.impl.combo.DefaultCombo().setText("/importTest");// - already set as target ws
		// folder on 1. page, the project
	}
