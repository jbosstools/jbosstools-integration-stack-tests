...
public class JBPM6ComplexEnvironment {
	...
	/**
	 * Use this method if you want selectively specify, which test should be run with graphiti and which not. Use
	 * -Dgraphiti.properties if you want all tests run with or without graphiti If -Dgraphiti.properties is used, this
	 * method won't take an effect.
	 * 
	 * @param value
	 */
