...
public enum ElementType {
	...
	COMPENSATION_INTERMEDIATE_THROW_EVENT("Intermediate Throw Events", "Compensation", CompensationIntermediateThrowEvent.class),
	ESCALATION_INTERMEDIATE_THROW_EVENT("Intermediate Throw Events", "Escalation", EscalationIntermediateThrowEvent.class),
	...
	private ElementType(String sectionName, String paletteToolName, String idOnCanvas, Class<? extends Element> implClass) {
	...
	public Class<? extends Element> getJavaClass(){
		if(implClass != null) {
			...
			throw new IllegalStateException("Please provide implementation class for " + paletteToolName + " to constructor of ElementType");
		}
	}
}
