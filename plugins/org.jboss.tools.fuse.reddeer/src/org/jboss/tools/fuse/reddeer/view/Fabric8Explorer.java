...
public class Fabric8Explorer extends WorkbenchView {
	 ...
	 * 
	 * @param name
	 *            name of a new fabric detail (if is <i>null</i>, a default value is used).
	 * @param url
	 *            Jolokia URL (if is <i>null</i>, a default value is used).
	 * @param username
	 *            User name.
	 * @param password
	 *            Password corresponding with a user.
	 * @param zoopassword
	 *            ZooKeeper password.
	 */
	 ...
	 * 
	 * @param name
	 *            name of the fabric detail (if is <i>null</i>, a default value is used).
	 */
	 ...
	 * 
	 * @param name
	 *            Name of a Fabric detail displayed in <i>Fabric Explorer</i>. If it's <i>null</i>, the default value
	 *            (Local Fabric) is used.
	 */
	 ...
	 * @param path
	 *            a location of the new profile (consider from the node <b>Versions</b> excluded)
	 */
	 ...
	 * 
	 * @param path
	 *            complete path to the profile in <i>Fabric Explorer</i> view.
	 */
	 ...
	 * 
	 * @param name
	 *            Name of the version. Can be null - default value is used
	 */
	 ...
	 * @param profiles
	 *            profiles assigned to the container
	 */
	 ...
	 * @param profile
	 *            name of the profile in Fabric Explorer--Local Fabric--Versions--1.0 view.
	 * 
	 ...
	 *            Name of the cloud
	 * @param identity
	 *            Identity to use on the cloud provider
	 * @param credential
	 *            Credential to use on the cloud provider
	 * @param owner
	 *            Owner of the EC2 account
	 */
	 ...
	 * @param zooPassword
	 *            the ZooKeeper password for the Fabric
	 * @param location
	 *            Location ID (e.g. 'eu-west-1')
	 * @param hardware
	 *            Hardware ID (e.g. 't1.micro')
	 * @param os
	 *            OS Family (e.g. 'rhel')
	 * @param osVersion
	 *            OS Version (e.g. '6')
