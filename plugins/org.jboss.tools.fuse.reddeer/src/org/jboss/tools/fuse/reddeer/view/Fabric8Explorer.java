...
public class Fabric8Explorer extends DefaultExplorer {
	 ...
	 * 
	 * @param name
	 *            name of a new fabric detail (if is <i>null</i>, a default
	 *            value is used).
	 * @param url
	 ...
	 * 
	 * @param name
	 *            name of the fabric detail (if is <i>null</i>, a default value
	 *            is used).
	 */
	 ...
	 * 
	 * @param name
	 *            Name of a Fabric detail displayed in <i>Fabric Explorer</i>.
	 ...
	 * @param path
	 *            a location of the new profile (consider from the node
	 *            <b>Versions</b> excluded)
	 */
	 ...
	 * @param profile
	 *            name of the profile in Fabric Explorer--Local
	 *            Fabric--Versions--1.0 view.
	 */
	...
	/**
	 * Returns a value of <i>FABs</i> of a profile given by a path in <i>Fabric
	 * Explorer</i>.
	 * 
	 * @param path
	 *            path to the node.
