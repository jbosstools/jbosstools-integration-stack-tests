...
public class Breakpoint extends DefaultTreeItem {
	...
	public enum TriggerOn {
		...
		ENTRY("ENTRY"), RETURN("RETURN"), FAULT("FAULT"), TRANSACTION("TRANSACTION"), SECURITY("SECURITY"), POLICY(
				"POLICY"), TARGET_INVOCATION("TARGET_INVOCATION"), VALIDATION("VALIDATION"), TRANSFORMATION(
				"TRANSFORMATION");
